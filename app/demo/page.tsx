...
export default function DemoWalkthroughPage() {
  ...
  const demoSteps = [
    ...
    {
      title: "4. Multi-Horizon Survival Analysis (Breslow Baseline Hazard)",
      desc: "Computes calibrated delay probabilities across 30d, 60d, 90d, and 180d horizons using literature-calibrated Breslow baseline hazard survival curves S(t) = S₀(t)^HR.",
      action: "View the custom SVG survival baseline curve and proportional hazards ratio.",
      route: "/dashboard",
      badge: "Survival Math",
    },
    {
      title: "5. Multi-Model Consensus Agreement Index",
      desc: "Assesses cross-model agreement between trained GradientBoostingClassifier and Breslow Survival Hazard to output a harmonized risk score and divergence telemetry.",
      action: "Check the multi-model consensus agreement strip with LOW/MEDIUM/HIGH divergence levels.",
      route: "/dashboard",
