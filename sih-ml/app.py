    ...
    try:
        ...
        return {
            ...
            "survival_analysis": {
                ...
                "ensemble_hazard_ratio": survival_data["hazard_ratio"],
                "cph_hazard_ratio": survival_data["cph_hazard_ratio"],
                "rsf_hazard_ratio": survival_data["rsf_hazard_ratio"],
                "ensemble_weights": survival_data["ensemble_weights"],
                "high_uncertainty": survival_data["high_uncertainty"],
                "model_disagreement_pct": survival_data["model_disagreement_pct"],
